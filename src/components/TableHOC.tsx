...
function TableHOC<T extends Object>(columns: Column<T>[], data: T[],containerClassname:string, 
  ...
  return function HOC() {
    ...
    const {getTableProps,getTableBodyProps,headerGroups, page, prepareRow,state:{pageIndex},
        canPreviousPage, canNextPage, pageCount, nextPage, previousPage} = useTable(options,useSortBy,usePagination)
